...
THREE.CanvasRenderer = function(a) {
	...
	this.render = function(a, j) {
		function i(a) {
			...
			ua.setRGB(0, 0, 0);
			b = 0;
			for(c = a.length; b < c; b++) d = a[b], e = d.color, d instanceof THREE.AmbientLight ? ($T.r += e.r, $T.g += e.g, $T.b += e.b) : d instanceof THREE.DirectionalLight ? (ta.r += e.r, ta.g += e.g, ta.b += e.b) : d instanceof THREE.PointLight && (ua.r += e.r, ua.g += e.g, ua.b += e.b)
		}
